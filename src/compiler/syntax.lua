...
local rules = {
	...
	--Array Concatenation
	{
		...
		keep = { 1, 3 },
		text = 2,
		not_before = { TOK.index_open, TOK.op_arrow, TOK.op_dot, TOK.kwd_if_expr, TOK.kwd_for_expr, TOK.op_plus, TOK.op_minus, TOK.op_count },
